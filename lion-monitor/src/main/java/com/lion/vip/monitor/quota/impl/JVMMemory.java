...
import com.lion.vip.monitor.quota.MemoryQuota;
...
public class JVMMemory implements MemoryQuota {
    ...
    private final List<String> permGenName =
            Lists.newArrayList("CMS Perm Gen",
                    "Perm Gen",
                    "PS Perm Gen",
                    "G1 Perm Gen");

    private final List<String> oldGenName =
            Lists.newArrayList("CMS Old Gen",
                    "Tenured Gen",
                    "PS Old Gen",
                    "G1 Old Gen");

    private final List<String> edenSpaceName =
            Lists.newArrayList("Par Eden Space",
                    "Eden Space",
                    "PS Eden Space",
                    "G1 Eden");

    private final List<String> psSurvivorName =
            Lists.newArrayList("Par Survivor Space",
                    "Survivor Space",
                    "PS Survivor Space",
                    "G1 Survivor");
    ...
    private MemoryPoolMXBean permGenMxBean;    //永久代
    private MemoryPoolMXBean oldGenMxBean;     //老年代
    private MemoryPoolMXBean edenSpaceMxBean;  //新生代Eden区
    private MemoryPoolMXBean pSSurvivorSpaceMxBean;    //新生代Survivor区
